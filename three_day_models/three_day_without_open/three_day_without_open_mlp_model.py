...
from three_day_models.three_day_without_open.three_day_without_open_data_frame_prep import get_data_frame_for_training
...
def prepare_model():
    model_this = MLPRegressor(hidden_layer_sizes=(15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,), max_iter=5000)
    return model_this
